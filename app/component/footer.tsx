      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4">
            ...
            <Link href={'www.linkedin.com/in/g-v-support-services-025a84376'}><SocialIcon icon="linkedin" /></Link>
            {/* www.linkedin.com/in/g-v-support-services-025a84376 */}
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <FooterLink href="/services/airport-meet" text="Airport Meet & Greet" />
            <FooterLink href="/services/housing" text="Short-term Housing" />
            <FooterLink href="/services/home-search" text="Home Search" />
